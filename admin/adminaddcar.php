...
<div class="header-bottom">
	<div class="wrap">
        ...
        <form class="text-center" action="adminaddcar.php" method="post" >
           ...
           <div>
              <label>اختيار موديل السيارة</label><br>
               
              <select name = "model" style="width:566px; height: 40px;" >
                <option value = "">|--اختيار سيارة--|</option>
                <option value = ""> </option>
      ...
      <input type="text" class="form-control transparent-input" size="50" placeholder="color" name="color">
            ...
            <div><br/>
                <button type="submit" name="add" class="btn btn-warning" value="add" onClick='alert("تم اضافة السيارة بنجاح")'> إضافة </button>
             </div>
         </form>     
          </div>
