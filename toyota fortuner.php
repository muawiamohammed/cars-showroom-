		    ...
		    <div class="menu-main">
			   <?php
                 if(isset($_SESSION['s_name']))
                 {
                    ...
                    echo '<li class="active"><a href="indexlogin.php">الرئسية</a></li>' ;
                    echo '<li><a href="services.php">العلامات التجارية</a></li>' ;
                    echo '<li><a href="booking.php">حجز</a></li>' ;
                    echo '<li><a href="orders.php">طلباتي</a></li>';
                ...
                {
                    echo '<ul class="dc_css3_menu">';
                    echo '<li class="active"><a href="index.php">الرئسية</a></li>';
                    echo '<li><a href="about.html">من نحن</a></li>';
                    echo '<li><a href="services.html">العلامات التجارية</a></li>';
                    echo '<li><a href="contact.php">تواصل معانا</a></li>';
                    echo '<li><a href="login.php">تسجيل الدخول </a></li>';
                    echo '<li><a href="register.php"> تسجيل حساب جديد</a></li>';
                    echo '</ul>' ;
